...
local Window = Library.CreateLib("RUTEX version 0.3 (not work)", "RJTheme7")
...
Section:NewToggle("JumpPower", "click to disable or enable the function", function (x)
    while game:GetService("RunService").RenderStepped:wait() do	
        if x then
...
Section:NewButton("eclipse hub", "https://discord.gg/mbVtnSw", function()
	getgenv().mainKey = "nil"
